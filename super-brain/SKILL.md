...
author: A1m1ng777888
license: MIT
description: "Super Brain 超脑认知增强技能 v3.3.0。Goal Continuation 续跑机制（零LLM开销）+ 前置编配评估始终在线（不需加载本 skill 即可自主判断任务复杂度），本 skill 负责正式评估+分解+规格生成+Goal评估+续跑+执行。触发词：记住、记忆、回忆、推理、纠缠、感知、分类、入库、搜索知识、知识图谱、自检、remember、recall、reason、entangle、perceive、之前、上次、那个、我们聊过、你之前说、别忘了、还有没有、相关的内容、帮我回忆、继续上次"
---

# Super Brain (超脑) — 认知增强技能 v3.3.0
