...
version: v1.0.0
released: 2026-06-26
description: "Super Brain 超脑认知增强技能。为 AI 提供跨会话持久记忆、知识图谱构建、SimHash 语义搜索、知识自检修复、Workspace 隔离管理等认知增强能力。触发词：记住、记忆、回忆、你记得吗、搜索知识、知识图谱、自检、健康检查、健康度、工作区、remember、recall、knowledge graph、self-check"
---

# Super Brain (超脑) — 认知增强技能 v1.0.0

## 概述

超脑是一个认知增强系统，为 AI 提供**持久记忆、知识图谱、语义搜索、自检修复**四大核心能力。它解决了 AI Agent 的七大先天缺陷：跨会话失忆、上下文断裂、被动响应、搜索低效、知识孤岛、错误固化、缺乏自愈。
...
- **核心认知层**：记忆引擎、知识图谱、感知增强、语义搜索、智能纠错、自检系统
- **存储层**：Workspace 隔离、基于文件的 JSON 存储
